...
export the credentials as an environment variables so that the integration tests can create resources in GCP.
...
```
export PROJECT_ID=<GCP Testing Project>
export REGION=<GCP Region>
export RUNTIME=<Cloud Function Runtime>
export SOURCE_ARCHIVE_BUCKET=<Cloud Storage Bucket that contains the Cloud Function zipfile>
export SOURCE_ARCHIVE_OBJECT=<Path to the Cloud Function zipfile>
export ENTRY_POINT=<The entrypoint function of the Cloud Function>
```
